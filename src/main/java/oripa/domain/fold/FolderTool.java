...
public class FolderTool {
	...
	// public void setCrossLine(List<OriLine> crossLines, OriLine line,
	// List<OriFace> sortedFaces) {
	// crossLines.clear();
	...
	// he.next.positionForDisplay.x, he.next.positionForDisplay.y,
	// PaintConfig.inputLineType);
	//
	// double params[] = new double[2];
	// boolean res = GeomUtil.getCrossPointParam(line.p0, line.p1, l.p0, l.p1,
	// params);
	// if (res == true && params[0] > -0.001 && params[1] > -0.001 && params[0]
	// < 1.001 && params[1] < 1.001) {
	// double param = params[1];
	// crossCount++;
	//
	// Vector2d crossV = new Vector2d();
	// crossV.x = (1.0 - param) * he.vertex.preP.x + param *
	// he.next.vertex.preP.x;
	// crossV.y = (1.0 - param) * he.vertex.preP.y + param *
	// he.next.vertex.preP.y;
	//
