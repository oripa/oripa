...
//	public static final BasicStroke STROKE_PAPER_EDGE = new BasicStroke(1.0f, BasicStroke.CAP_BUTT,
//			BasicStroke.JOIN_MITER);
//	public static final BasicStroke STROKE_VALLEY = new BasicStroke(1.0f, BasicStroke.CAP_BUTT,
//			BasicStroke.JOIN_MITER);
//	public static final BasicStroke STROKE_RIDGE = new BasicStroke(1.0f, BasicStroke.CAP_BUTT,
//			BasicStroke.JOIN_MITER);
//	public static final BasicStroke STROKE_PICKED = new BasicStroke(1.0f, BasicStroke.CAP_BUTT,
//			BasicStroke.JOIN_MITER);
//	public static final BasicStroke STROKE_GRID = new BasicStroke(1.0f, BasicStroke.CAP_BUTT,
//			BasicStroke.JOIN_MITER);
//	public static final BasicStroke STROKE_MOVING = new BasicStroke(1.0f, BasicStroke.CAP_BUTT,
//			BasicStroke.JOIN_MITER);

//	static final float[] dash = { 3.0f };
//
//	public static final BasicStroke STROKE_SELECT_BY_AREA = new BasicStroke(1.0f,
...
//	public static final BasicStroke STROKE_CUT_MODEL = new BasicStroke(1.5f, BasicStroke.CAP_BUTT,
//			BasicStroke.JOIN_MITER);
