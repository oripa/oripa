...
public class VerticesManager implements NearVerticesGettable {
	...
	/* (non Javadoc)
	 * @see oripa.domain.creasepattern.NearVerticesGettable#getAround(javax.vecmath.Vector2d)
	 */
	@Override
	...
	/* (non Javadoc)
	 * @see oripa.domain.creasepattern.NearVerticesGettable#getArea(double, double, double)
	 */
	@Override
