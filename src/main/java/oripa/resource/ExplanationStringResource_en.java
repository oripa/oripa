...
public class ExplanationStringResource_en extends ListResourceBundle {
	...
	static final Object[][] strings = {
			...
			{ StringID.POINT_TO_LINE_POINT_TO_LINE_ID,
					"Specify a point and a line twice, select crease, and select end points." },

			{ StringID.POINT_TO_LINE_THROUGH_POINT_ID,
					"Specify a point and a line to meet, specify a point that crease passes, select crease, and select end points." },

			{ StringID.POINT_TO_LINE_LINE_PERPENDICULAR_ID,
					"Specify a point and a line to meet, specify a line perpendicular to the crease, and select end points. " },
