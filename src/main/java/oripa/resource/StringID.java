...
public class StringID {
	public static class Main {
		...
		public static final String COLOR_SCHEME_ID = "ColorScheme";
		public static final String CLASSIC_COLOR_ID = "Classic";
		public static final String LANG_COLOR_ID = "Lang";
