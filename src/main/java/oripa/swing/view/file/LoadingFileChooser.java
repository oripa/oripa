 ...
 *
 */
public class LoadingFileChooser<Data> extends JFileChooser implements FileChooserView {

	public LoadingFileChooser(final String path, final Collection<FileAccessSupport<Data>> supports) {
		super(path);
		if (path != null) {
