package oripa.controller.paint.geometry;
...
public class NearestVertexFinderHelper {
	 ...
	 */
	public static NearestPoint findAround(PaintContextInterface context, double distance){
...
//					", scaled limit = " + distance);
	...
	public static NearestPoint findFromPickedLine(PaintContextInterface context){
