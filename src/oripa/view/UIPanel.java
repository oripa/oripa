...
implements ActionListener, PropertyChangeListener, KeyListener, Observer {
	...
	private UIPanelSettingDB settingDB = null;
	...
	public UIPanel(MainScreen __screen) {
		...
		settingDB = UIPanelSettingDB.getInstance();
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (ae.getSource() == lineInputDirectVButton) {
			...
			Globals.mouseAction = new SymmetricalLineAction();
...
//			modeChanged();
			...
			Globals.mouseAction = new LengthMeasuringAction();
	...
	void modeChanged() {
		...
		setting.setSubPanelVisible(bDispSubPanel);
