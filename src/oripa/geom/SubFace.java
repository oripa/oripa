...
public class SubFace {
    ...
    public ArrayList<ArrayList> answerStacks = new ArrayList<>();
    ...
    private boolean checkForSortLocally3(OriFace face) {
        ...
        // stack lower2 < lower1, without upper1 being stacked, dont stack upper2
        // stack lower1 < lower2, without upper2 being stacked, dont stack upper1
        ...
        for (Condition4 cond : face.condition4s) {
            ...
            if (face.tmpInt == cond.upper2
                    ...
                    && ORIPA.doc.faces.get(cond.lower2).tmpInt2 < ORIPA.doc.faces.get(cond.lower1).tmpInt2) {
                return false;
            }
            if (face.tmpInt == cond.upper1
                    ...
                    && ORIPA.doc.faces.get(cond.lower1).tmpInt2 < ORIPA.doc.faces.get(cond.lower2).tmpInt2) {
                return false;
            }
        }
        return true;
