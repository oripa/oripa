    ...
    public static void exportModel(Doc doc, String filepath) throws Exception {
        ...
        try (BufferedWriter bw = new BufferedWriter(fw)) {
            ...
            for (int i=0; i<sortedFaces.size(); i++) {
                OriFace face = RenderScreen2.m_bFaceOrderFlip ? sortedFaces.get(i)
                ...
                if((!face.faceFront&&RenderScreen2.m_bFaceOrderFlip)
                        || (face.faceFront&&!RenderScreen2.m_bFaceOrderFlip)){
